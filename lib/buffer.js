...
Buffer.prototype.concat = function(other) {
  return new Buffer(this._data.concat(other._data));
};
...
Buffer.prototype.copy = function(target, targetStart, sourceStart, sourceEnd) {
  ...
  var chunk = this._data.slice(sourceStart, sourceEnd),
      args  = [targetStart, sourceEnd - sourceStart].concat(chunk);

  target._data.splice.apply(target._data, args);
};
