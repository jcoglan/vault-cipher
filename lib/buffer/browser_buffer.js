...
['', 'U'].forEach(function(sign) {
  ...
  ['BE', 'LE'].forEach(function(endianness) {
    var readStub  = readInt(sign, endianness),
        ...
        method    = sign + 'Int' + endianness;

    Buffer.prototype['read' + method] = function(offset, byteLength, noAssert) {
      return readStub(byteLength).call(this, offset, noAssert);
    };

    Buffer.prototype['write' + method] = function(value, offset, byteLength, noAssert) {
      return writeStub(byteLength).call(this, value, offset, noAssert);
    };
